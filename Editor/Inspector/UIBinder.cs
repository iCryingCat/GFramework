...
namespace GFramework.EditorExtern
{
    ...
    public class UIBinder : Editor
    {
        ...
        private void UpdateViewCode()
        {
            ...
            {
                GLog.E("Ediotr.UIBinder", "不要在预览模式刷新代码！！！");
                return;
            }
            ...
            for (int i = 0; i < lines.Length; ++i)
            {
                ...
                if (lines[i].Contains("// ++"))
                {
                    ...
                    {
                        string fieldType = fieldTuples[j].Item1;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField(this.binder.targetViewPath);
            base.OnInspectorGUI();
